...
- 🧪 **Query**: `db.restaurants.find({borough:"Bronx"}, {_id:0, name:1, borough: 1})`
- ⏱️ **Execution time**: 0 ms
...
- 🧪 **Query**: `db.restaurants.find({$or:[{cuisine:{$regex:/Fish/i}}, {$and:[{cuisine:{$ne:"American"}},{cuisine: {$ne:"Chinese"}}]},{name:{$regex:/^Will/i}}]}, {_id:0, restaurant_id:1, name:1, cuisine:1,})`
- ⏱️ **Execution time**: 2 ms
- 📚 **Documents returned**: 389
- 🔍 **Documents examined**: 664
...
- 🧪 **Query**: `db.restaurants.find({}, {_id:0}).sort({cuisine:1, name:-1})`
- ⏱️ **Execution time**: 2 ms
- 📚 **Documents returned**: 664
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: SORT
...
- 🧪 **Query**: `db.restaurants.find({"address.street":{$exists: false}},{_id:0, restaurant_id:1, name:1, address:1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 2
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_SIMPLE
...
- 🧪 **Query**: `db.restaurants.find({"address.coord": {$type:"double"}}, {_id:0, restaurant_id:1, name:1, "address.coord":1})`
- ⏱️ **Execution time**: 1 ms
- 📚 **Documents returned**: 0
- 🔍 **Documents examined**: 664
- 🛠️ **Execution stage**: PROJECTION_DEFAULT
...
- 🧪 **Query**: `db.restaurants.find({"grades.score":{$mod:[7, 0]}}, {_id:0, restaurant_id:1, name:1, "grades.score":1})`
- ⏱️ **Execution time**: 2 ms
...
- 🧪 **Query**: `db.restaurants.find({name:{ $regex: /mon/i}},{_id:0, name:1, borough:1, "address.coord.0":1, "address.coord.1":1,cuisine:1})`
- ⏱️ **Execution time**: 1 ms
